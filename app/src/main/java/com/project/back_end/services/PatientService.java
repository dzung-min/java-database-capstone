...
public class PatientService {
    ...
    public List<AppointmentDTO> filterByCondition(Integer condition, Long patientId) {
        try {
            List<Appointment> appointments = appointmentRepository.findByPatientId(patientId).stream()
                    .filter(appointment -> appointment.getStatus() == condition)
                    .collect(Collectors.toList());
    ...
    private AppointmentDTO convertToDTO(Appointment appointment) {
        // Implement the logic to convert an Appointment entity to an AppointmentDTO
        // This will involve mapping the relevant fields from the Appointment to the
        // DTO, including doctor and patient information.
        // You can use a library like ModelMapper or MapStruct for this conversion, or
        // do it manually.
